      ...
      <div className="row">
        ...
        <div className="col-8" style={{ background: "#DBDDFF", height: "670px" }}>
          <div className="row me-2">
            ...
            <div className="col-6" style={{ marginTop: "180px", position: "relative", cursor:'pointer'}}>
          ...
          <div className="row me-2">
            <div className="col-6" style={{ marginTop: "20px", cursor:'pointer'}}>
            ...
            <div className="col-6" style={{ marginTop: "130px", position: "relative", cursor:'pointer'}}>
          ...
          <div className="row me-2">
            <div className="col-6" style={{ marginTop: "4px", cursor:'pointer'}}>
              <p className="bg-primary border border-primary text-white mb-2 ms-5 me-5 p-3" style={{ borderRadius: "9px", fontFamily: "Roboto" }}>
                Baik pak, terima kasih. Saya akan datang tepat waktu.
              </p>
            </div>
